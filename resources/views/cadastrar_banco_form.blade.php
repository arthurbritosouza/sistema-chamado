...
<div class="container">
  <div class="navbar">
    ...
    <a href="#" class="left">Bancos de chamados</a>
    <div class="right">
      <a href="#" class="right">
  ...
  <form action="/cadastrar_banco" method="POST">
    @csrf
    <div class="form-group">
      <label for="nome_chamado">Nome do Banco:</label>
      <input type="text" id="nome_banco" name="nome_banco" class="form-control">
    </div>
